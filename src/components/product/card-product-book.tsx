    ...
    >
      ...
      >
        ...
        {layout === ELayoutProduct.GRID && (
          <div className="w-full absolute -bottom-10 flex gap-4 justify-center group-hover:bottom-4 transition-all duration-500">
        ...
        {layout === ELayoutProduct.LIST && (
          <div className={cn("flex gap-4 transition-all duration-500")}>
            <AddtoCartButton
              product={product}
              quantity={1}
              className="bg-transparent text-black border border-gray-300 hover:bg-primary hover:text-white hover:border-transparent"
            />
            <QuickViewIcon product={product} />
            <AddtoWishlistIcon product={product} />
          </div>
