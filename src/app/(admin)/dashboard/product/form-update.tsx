...
import { CategoryInProduct, Product } from "~/modules/product/models/Product";
...
export function FormUpdate({ product, updateProduct }: Props) {
      ...
      <DialogContent className="bg-gray-100 py-2 sm:max-w-[1025px]">
        ...
        <div className="grid grid-cols-6 space-x-16">
          ...
          <Form {...form}>
            ...
            >
              <CategorySelect category={product.category} form={form} />
